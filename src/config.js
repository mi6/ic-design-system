...
module.exports = {
  ...
  FOOTER_PROPS: {
    ...
    content:
      "The UK Intelligence Community Design System (ICDS) is a joint project by MI6, MI5, GCHQ, and HMGCC, our national security partner, along with other collaborators.",
    caption:
