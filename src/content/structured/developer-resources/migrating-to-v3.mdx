---
path: "/developer-resources/migrating-to-v3"
...
- The `appearance` prop has been replaced with the `theme` and `monochrome` [props](/components/theme-customisation/theme#dark-mode-as-a-theme).
