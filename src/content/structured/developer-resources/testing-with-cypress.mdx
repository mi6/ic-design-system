---
path: "/developer-resources/test-components/testing-with-cypress"
...
contribute: "https://github.com/mi6/ic-design-system/tree/main/src/content/structured/developer-resources/testing-with-cypress.mdx"
---
...
Cypress gives two ways in which to test `@ukic` components in the [shadow DOM](/developer-resources/test-components#how-weve-built-the-components).
