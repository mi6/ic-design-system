...
<ComponentPreview
  ...
  type="pattern"
>
  <LinkToNewWin href="/side-navigation-pattern" />
</ComponentPreview>
...
<ComponentPreview
  ...
  type="pattern"
>
  <LinkToNewWin href="/side-navigation-page-header-pattern" />
</ComponentPreview>
...
export const snippetsSideNavBackToTop = [
  ...
  return (
    <div className={classes.parentDiv}>
      ...
      <div className={classes.contentDivContainer}>
         id="main" className={classes.main}>
          <IcSectionContainer
            aligned={alignment}
            className={classes.mainSectionContainer}
          >
...
<ComponentPreview
  ...
  type="pattern"
>
  <LinkToNewWin href="/side-navigation-back-to-top-pattern" />
</ComponentPreview>
...
<DoDontCaution
  ...
  state="none"
  caption="An example of the side navigation layout branded to an alternative colour."
/>
