...
>
  <LinkToNewWin href="/top-navigation-pattern" />
</ComponentPreview>
...
- [Mega-menu](/components/navigation/top-navigation)
...
For more information, see the [page header component](/components/navigation/page-header).
...
>
  <LinkToNewWin href="/top-navigation-page-header-pattern" />
</ComponentPreview>
...
For more information, see the [mega-menu component](/components/navigation/top-navigation#mega-menu).
...
>
  <LinkToNewWin href="/top-navigation-mega-menu-pattern" />
</ComponentPreview>
...
For more information, see the [back to top component](/components/navigation/back-to-top).
...
>
  <LinkToNewWin href="/top-navigation-back-to-top-pattern" />
</ComponentPreview>

## Customisation

This pattern can be branded to change the look and feel of the app. Use the [custom theme and branding](/components/theme-customisation/theme) guidance to change your app's brand. Make sure to select your brand in line with the accessibility requirements around colour contrast.

<DoDontCaution
  imageSrc={[Fig1ThemingTopNavLight, Fig1ThemingTopNavDark]}
  imageAlt="An example page showing the layout with an alternatively branded look."
  state="none"
  caption="An example of the top navigation layout branded to an alternative colour."
/>
