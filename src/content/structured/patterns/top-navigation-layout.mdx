...
This pattern can be branded to change the look and feel of the app. Use the [custom theme and branding](/components/theme) guidance to change your app's brand. Make sure to select your brand in line with the accessibility requirements around colour contrast.
