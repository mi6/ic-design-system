...
Use the top navigation layout with mega-menu for access to a large range of navigation items.

Use mega-menu for apps with complex page structures where every page should be accessible from any other page through the mega-menu. For example, department stores or supermarkets use a top navigation with mega-menu to provide access to their large number of product categories.
...
For more information see [page header](/components/page-header).
...
For more information see [mega-menu](/components/top-navigation).
...
For more information see [back to top](/components/back-to-top).
