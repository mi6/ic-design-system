...
const iconList: IconGroup[] = [
  ...
  },
  {
    ...
    icons: [
      ...
      {
        icon: <Icon size={ICON_SIZE} path={mdiCloseOctagon} color="#D4351C" />,
        name: "Error",
        library: "mdiCloseOctagon",
      },
      {
        icon: <Icon size={ICON_SIZE} path={mdiInformation} color="#124DB3" />,
        name: "Information",
        library: "mdiInformation",
      },
      {
        icon: <Icon size={ICON_SIZE} path={mdiHelpBox} color="#6C7580" />,
        name: "Unknown",
        library: "mdiHelpBox",
      },
    ],
