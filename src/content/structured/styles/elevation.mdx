...
| <span class="css-token">--ic-z-index-page-header</span>           | [Page header](/components/navigation/page-header)                                                                                              | Base + 10              |
| <span class="css-token">--ic-z-index-back-to-top</span>           | [Back to top](/components/navigation/back-to-top)                                                                                              | Base + 20              |
| <span class="css-token">--ic-z-index-menu</span>                  | Menu for [select](/components/inputs/select) and [search bar](/components/inputs/search-bar)                                                   | Base + 50              |
| <span class="css-token">--ic-z-index-popover</span>               | [Popover menu](/components/navigation/popover-menu)                                                                                            | Base + 50              |
| <span class="css-token">--ic-z-index-navigation-item</span>       | Navigation item used in [top navigation](/components/navigation/top-navigation) and [side navigation](/components/navigation/side-navigation). | Base + 50              |
| <span class="css-token">--ic-z-index-navigation-menu</span>       | Navigation menu used in [top navigation](/components/navigation/top-navigation) at smaller breakpoints.                                        | Base + 60              |
| <span class="css-token">--ic-z-index-side-navigation</span>       | [Side navigation](/components/navigation/side-navigation)                                                                                      | Base + 60              |
| <span class="css-token">--ic-z-index-dialog</span>                | [Dialog](/components/feedback-progress/dialog)                                                                                                 | Base + 100             |
| <span class="css-token">--ic-z-index-tooltip</span>               | [Tooltip](/components/feedback-progress/tooltip)                                                                                               | Base + 110             |
| <span class="css-token">--ic-z-index-toast</span>                 | [Toast](/components/feedback-progress/toast)                                                                                                   | Base + 110             |
| <span class="css-token">--ic-z-index-classification-banner</span> | [Classification banner](/components/utility/classification-banner)                                                                             | Base + 200             |
