...
Only use bold to refer to text from interfaces in technical documentation or instructions - use bold to explain what field a user needs to fill in on a form, or which button they need to select. For example: “Select **Continue** to open the certificate window.”
