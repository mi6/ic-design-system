...
We don't use block capitals for bodies of text as they're difficult for people to read. An exception to this is when drawing attention to single words such as destructive button labels.
