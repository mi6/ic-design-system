...
If you use the [IC UI Kit](/components), the foreground colour will be automatically determined based on your brand colour.

The brand colour is used on the [top navigation](/components/top-navigation), [side navigation](/components/side-navigation), [hero](/components/hero) and [footer](/components/footer) components.

Don't use brand colours on any other components.
...
If using a 'light' brand colour, any text in those components will need to be black instead of white. This is automatic if you're using the IC UI Kit. It's not possible to use 'inaccessible' colours in the IC UI Kit as they'll revert to the default brand colour. See the component documentation for more details.
