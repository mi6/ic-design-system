...
export const snippetsStatus = [
  {
    language: "Web component",
    snippet: `<ic-button variant="secondary" style="margin-right:16px">
  <ic-badge slot="badge" variant="neutral"></ic-badge>
  Neutral
</ic-button>
<ic-button variant="secondary" style="margin-right:16px">
...
<ic-button variant="secondary" style="margin-right:16px">
  <ic-badge slot="badge" variant="error"></ic-badge>
  Error
</ic-button>
<ic-button variant="secondary" style="margin-right:16px">
  <ic-badge slot="badge" variant="success"></ic-badge>
  Success
</ic-button>`,
  },
  {
    language: "React",
    snippet: `<IcButton variant="secondary" style={{marginRight:"16px"}}>
  <IcBadge slot="badge" variant="neutral"/>
  Neutral
</IcButton>
<IcButton variant="secondary" style={{marginRight:"16px"}}>
...
<IcButton variant="secondary" style={{marginRight:"16px"}}>
  <IcBadge slot="badge" variant="error"/>
  Error
</IcButton>
<IcButton variant="secondary" style={{marginRight:"16px"}}>
  <IcBadge slot="badge" variant="success"/>
  Success
</IcButton>`,
  },
];
