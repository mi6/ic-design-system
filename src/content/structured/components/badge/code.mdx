...
<ic-button variant="secondary" style="margin-right:16px">
  <ic-badge slot="badge" text-label="Warning" variant="warning"></ic-badge>
  Coffee orders
</ic-button>
<ic-button variant="secondary" style="margin-right:16px">
  <ic-badge slot="badge" text-label="Notification" variant="light"></ic-badge>
  Coffee orders
</ic-button>`,
  },
  {
...
<IcButton variant="secondary" style={{marginRight:"16px"}}>
  <IcBadge slot="badge" text-label="Warning" variant="warning" />
  Coffee orders
</IcButton>
<IcButton variant="secondary" style={{marginRight:"16px"}}>
  <IcBadge slot="badge" text-label="Notification" variant="light" />
  Coffee orders
</IcButton>`,
  },
];
...
<ComponentPreview snippets={snippetsStatus}>
  ...
  <IcButton variant="secondary" style={{ marginTop: "16px" }}>
    <IcBadge slot="badge" text-label="Notification" variant="light" />
    Coffee orders
  </IcButton>
</ComponentPreview>
...
export const snippetsCustomColour = [
  ...
  {
    language: "React",
    snippet: `<IcButton variant="secondary" style={{ marginTop: '16px' }}>
  <IcBadge
    slot="badge"
    text-label="Notification"
    variant="custom"
    customColor={"rgb(255,192,203)"}
  />
  Coffee orders
</IcButton>`,
  },
...
<ComponentPreview snippets={snippetsCustomColour}>
  <IcButton variant="secondary" style={{ marginTop: "16px" }}>
    <IcBadge
      slot="badge"
      text-label="Notification"
