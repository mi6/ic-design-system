...
There are three types of badges available:
...
<DoDontCaution
  ...
  caption="Three types of badge are available, a text badge, an icon badge, and a dot badge."
/>
...
For example, for an application showing different system statuses, don’t place multiple status badges on a component to show separate information such as online status as well as system health status.
...
Badges are always positioned in the top right corner of the component it is attached to. Make sure the badge overlaps the border of the component by adjusting the badge’s positioning using the ‘far’ and ‘near’ positioning options. For square components use the ‘far’ positioning option, and for rounded components use the ‘near’ positioning.
