...
[Multi-select](../canary/select-with-multi/) is currently available as a canary comomponent. Guidance on canary components can be found [here](/components/canary).
