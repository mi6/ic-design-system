...
export const snippetsSmall = [
  {
    language: "Web component",
    snippet: `<ic-page-header size="small" heading="App title" subheading="App information"></ic-page-header>`,
  },
  {
    language: "React",
    snippet: `<IcPageHeader size="small" heading="App title" subheading="App information" />`,
  },
];

<ComponentPreview snippets={snippetsSmall} style={{ flexDirection: "column" }}>
  <IcPageHeader size="small" heading="App title" subheading="App information" />
</ComponentPreview>
