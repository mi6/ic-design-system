---
path: "/components/feedback-progress/dialog"
...
<DoDontCaution
  imageSrc={[Fig1DialogLight, Fig1DialogDark]}
...
<DoDontCaution
  imageSrc={[Fig2DialogLight, Fig2DialogDark]}
...
<DoDontCaution
  imageSrc={[Fig3DialogLight, Fig3DialogDark]}
...
Add a status [alert](/components/feedback-progress/alert) to a dialog to provide additional meaning in relation to a specific status. These can include any alert status variant.

<DoDontCaution
  imageSrc={[Fig4DialogLight, Fig4DialogDark]}
...
<DoDontCaution
  imageSrc={[Fig5DialogLight, Fig5DialogDark]}
...
<DoDontCaution
  imageSrc={[Fig6DialogLight, Fig6DialogDark]}
...
<DoDontCaution
  imageSrc={[Fig7DialogLight, Fig7DialogDark]}
