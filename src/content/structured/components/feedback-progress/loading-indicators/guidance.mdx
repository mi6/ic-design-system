---
path: "/components/feedback-progress/loading-indicator"
...
contribute: "https://github.com/mi6/ic-design-system/tree/main/src/content/structured/components/feedback-progress/loading-indicator"
...
tabs:
  [
    ...
    {
      title: "Code",
      path: "/components/feedback-progress/loading-indicator/code",
    },
    {
      title: "Accessibility",
      path: "/components/feedback-progress/loading-indicator/accessibility",
    },
  ]
...
Avoid using loading indicators when loading full pages if the structure of the page loading is known. Instead, use the [skeleton](/components/feedback-progress/skeleton) component.
