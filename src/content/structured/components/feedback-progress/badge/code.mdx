---
path: "/components/feedback-progress/badge/code"
...
contribute: "https://github.com/mi6/ic-design-system/tree/main/src/content/structured/components/feedback-progress/badge"

tabs:
  [
    { title: "Guidance", path: "/components/feedback-progress/badge" },
    { title: "Code", path: "/components/feedback-progress/badge/code" },
    {
      title: "Accessibility",
      path: "/components/feedback-progress/badge/accessibility",
    },
  ]
---
...
<ic-button variant="secondary">
  <ic-badge slot="badge" type="icon" label="Recommendations" variant="ai">
    <svg 
      slot="badge-icon"
...
<IcButton variant="secondary">
  <IcBadge slot="badge" type="icon" label="Recommendations" variant="ai">
    <SlottedSVG slot="badge-icon" viewBox="0 0 24 24" path={mdiCreation} />
  </IcBadge>
  Coffee orders
</IcButton>`,
      long: [
