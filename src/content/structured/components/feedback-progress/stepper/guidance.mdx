---
path: "/components/feedback-progress/stepper"
...
contribute: "https://github.com/mi6/ic-design-system/tree/main/src/content/structured/components/feedback-progress/stepper"

tabs:
  [
    { title: "Guidance", path: "/components/feedback-progress/stepper" },
    { title: "Code", path: "/components/feedback-progress/stepper/code" },
    {
      title: "Accessibility",
      path: "/components/feedback-progress/stepper/accessibility",
    },
  ]
...
<DoDontCaution
  imageSrc={[Fig1StepperLight, Fig1StepperDark]}
...
<DoDontCaution
  imageSrc={[Fig6StepperLight, Fig6StepperDark]}
...
<DoDontCaution
  imageSrc={[Fig7StepperLight, Fig7StepperDark]}
...
<DoubleDoDontCaution>
  <DoDontCaution
    imageSrc={[Fig8StepperLight, Fig8StepperDark]}
...
<DoDontCaution
  imageSrc={[Fig2StepperLight, Fig2StepperDark]}
...
<DoDontCaution
  imageSrc={[Fig3StepperLight, Fig3StepperDark]}
...
<DoDontCaution
  imageSrc={[Fig4StepperLight, Fig4StepperDark]}
...
<DoDontCaution
  imageSrc={[Fig5StepperLight, Fig5StepperDark]}
...
Validate each step as the user moves through the process. Use the standard error handling approach to display inline [alert](/components/feedback-progress/alert) and error messages if the user attempts to proceed to the next step without first completing the current step correctly.
