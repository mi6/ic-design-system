---
path: "/components/feedback-progress/chip"
...
[Action Chip guidance](/components/feedback-progress/action-chip) can be found on a dedicated page.
...
Don't use static chips to show status. Use [status tags](/components/feedback-progress/status-tag) instead.
...
- [Status tags](/components/feedback-progress/status-tag)
