---
path: "/components/feedback-progress/status-tag"
...
contribute: "https://github.com/mi6/ic-design-system/tree/main/src/content/structured/components/feedback-progress/status-tag"

tabs:
  [
    { title: "Guidance", path: "/components/feedback-progress/status-tag" },
    { title: "Code", path: "/components/feedback-progress/status-tag/code" },
    {
      title: "Accessibility",
      path: "/components/feedback-progress/status-tag/accessibility",
    },
  ]
...
Don't use status tags to display anything other than status, use [static chips](/components/feedback-progress/chip/#static-chips).
