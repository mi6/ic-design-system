---
path: "/components/feedback-progress/toast"
...
If the message must be seen, use an [alert](/components/feedback-progress/alert) or dialog depending on the severity of the problem.
