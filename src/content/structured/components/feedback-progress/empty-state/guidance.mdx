---
path: "/components/feedback-progress/empty-state"
...
contribute: "https://github.com/mi6/ic-design-system/tree/main/src/content/structured/components/feedback-progress/empty-state"

tabs:
  [
    { title: "Guidance", path: "/components/feedback-progress/empty-state" },
    { title: "Code", path: "/components/feedback-progress/empty-state/code" },
    {
      title: "Accessibility",
      path: "/components/feedback-progress/empty-state/accessibility",
    },
  ]
---
...
Don’t use empty states to communicate other messages to people that are not related to something being empty, use [alerts](/components/feedback-progress/alert) or [toasts](/components/feedback-progress/toasts) instead. Only use empty states in situations where no data is present to display.
...
Don’t use empty states to indicate something is loading, instead use a [loading indicator](/components/feedback-progress/loading-indicator).
