---
path: "/components/feedback-progress/alert"
...
Alerts have six status variants:
...
Don’t use alerts for passive feedback on a process, for example 'draft discarded' or 'email sent'. Use [toasts](/components/feedback-progress/toast) instead.
...
- [Toasts](/components/feedback-progress/toast)
