  ...
  ></ic-skeleton>
      ...
      long: `<body>
        <div>
          ...
          <br />
          <ic-button variant="primary" onClick="refresh()" }}>
           <svg
             slot="icon"
    ...
    <script>
    const skeletonContent = \`<ic-card-vertical heading="Americano Order" subheading="Name: Michael">
      <ic-skeleton
        slot="icon"
        variant="circle"
        style="height: var(--ic-space-xl); width: var(--ic-space-xl)"
    ...
    const cardContent =\`<ic-card-vertical
