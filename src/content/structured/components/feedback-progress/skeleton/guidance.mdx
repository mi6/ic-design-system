---
path: "/components/feedback-progress/skeleton"
...
Don’t use skeleton loading states when the loading progress can be calculated. Instead, use [determinate loading indicators](/components/feedback-progress/loading-indicator).

Don’t use skeleton components when the general structure of the page that will replace skeleton variants is not known. Instead, use [indeterminate loading indicators](/components/feedback-progress/loading-indicator).

## Related components

- [Loading indicators](/components/feedback-progress/loading-indicator)
