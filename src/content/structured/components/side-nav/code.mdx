...
### Page layout with fixed side navigation
...
### Page layout with inline side navigation

export const basicLayoutInline = [
  {
    language: "Web-components",
    snippet: `// Inline styling added for verboseness
<div style="height: 700px; margin: 15px;transform: translateZ(0); overflow: hidden;">
  <div style='width: 100%; height: 100%;'>
    <div style='display: flex; height: 100%;'>
      ...
      <div style='height: 100%; overflow-y: auto; flex-grow: 1; display: flex; flex-direction: column;'>
        <main style="display:flex; flex-direction: column; flex: 1 0 100%;">
          <ic-section-container>
            <ic-typography>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed vestibulum venenatis facilisis. Nam tortor felis, auctor vel ante quis, tempor interdum libero. In dictum sodales velit, eu egestas arcu dignissim ac. Aliquam facilisis eros dolor, id laoreet orci sagittis ut. Sed tempus, lacus in pretium molestie, lectus magna interdum risus, vel fringilla libero ex eu dui. Suspendisse ullamcorper vehicula lacinia. Phasellus congue velit nisl, vitae congue ligula rutrum id.</p>
            </ic-typography>
...
<div style={{height: '700px', margin: '15px', transform: 'translateZ(0)', overflow: 'hidden'}}>
  <div style={{width: '100%', height: '100%'}}>
    <div style={{display: 'flex', height: '100%'}}>
      ...
      <div style={{height: '100%', overflowY: 'auto', flexGrow: '1', display: 'flex', flexDirection: 'column'}}>
  ...
  <div style={{height: '700px', margin: '15px', transform: 'translateZ(0)', overflow: 'hidden'}}>
    <div style={{width: '100%', height: '100%'}}>
      <div style={{display: 'flex', height: '100%'}}>
        ...
        <div style={{height: '100%', overflowY: 'auto', flexGrow: '1', display: 'flex', flexDirection: 'column'}}>
          <main style={{display: 'flex', flexDirection: 'column', flex: '1 0 100%'}}>
            <IcSectionContainer>
              <IcTypography>
                <p>
