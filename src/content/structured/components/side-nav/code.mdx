...
import { mdiCompassOutline, mdiHome } from "@mdi/js";
...
### With MUI icons in SlottedSVG

export const withMUIicons = [
  {
    language: "React",
    snippet: `<MemoryRouter initialEntries={["/"]}>
  <div style={{ display: "flex", flexDirection: "row"}}>
...
>
  <IcSideNavigation
    ...
    inline
  >
    <SlottedSVG slot="app-icon" path={mdiCompassOutline} viewBox="0 0 24 24" />
    <IcNavigationItem slot="primary-navigation" href="/" label="Home">
