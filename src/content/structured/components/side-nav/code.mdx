...
export const snippetsDefault = [
  {
    ...
    snippet: `<ic-side-navigation appTitle="ACME coffee shop" version="v0.0.7" status="Alpha" href="#">
...
export const snippetsStatic = [
  {
    language: "Web component",
    snippet: `<ic-side-navigation appTitle="ACME coffee shop" version="v0.0.7" status="Alpha" static="true" href="#">
  <svg slot="app-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <title>coffee-outline</title>
    <path d="M2,21V19H20V21H2M20,8V5H18V8H20M20,3A2,2 0 0,1 22,5V8A2,2 0 0,1 20,10H18V13A4,4 0 0,1 14,17H8A4,4 0 0,1 4,13V3H20M16,5H6V13A2,2 0 0,0 8,15H14A2,2 0 0,0 16,13V5Z" />
  </svg>
...
export const snippetsCollapsed = [
  {
    language: "Web component",
    snippet: `<ic-side-navigation app-title="ACME coffee shop" version="v0.0.0" status="Alpha" collapsed-icon-labels="true" href="#">
  <svg slot="app-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <title>coffee-outline</title>
    <path d="M2,21V19H20V21H2M20,8V5H18V8H20M20,3A2,2 0 0,1 22,5V8A2,2 0 0,1 20,10H18V13A4,4 0 0,1 14,17H8A4,4 0 0,1 4,13V3H20M16,5H6V13A2,2 0 0,0 8,15H14A2,2 0 0,0 16,13V5Z" />
  </svg>
