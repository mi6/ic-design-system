...
contribute: "https://github.com/mi6/ic-design-system/tree/main/src/content/structured/components/layout/footer"

tabs:
  [
    { title: "Guidance", path: "/components/layout/footer" },
    { title: "Code", path: "/components/layout/footer/code" },
    { title: "Accessibility", path: "/components/layout/footer/accessibility" },
  ]
---
...
Position the footer adjacent to the [side navigation](/components/navigation/side-navigation) if your app uses one.
