---
path: "/components/layout/card-vertical"
...
contribute: "https://github.com/mi6/ic-design-system/tree/main/src/content/structured/components/layout/card-vertical"

tabs:
  [
    { title: "Guidance", path: "/components/layout/card-vertical" },
    { title: "Code", path: "/components/layout/card-vertical/code" },
    {
      title: "Accessibility",
      path: "/components/layout/card-vertical/accessibility",
    },
  ]
---
...
import {
  Fig10VerticalCardDark,
  Fig10VerticalCardLight,
  Fig11VerticalCardDark,
  Fig11VerticalCardLight,
  Fig1VerticalCardDark,
  Fig1VerticalCardLight,
  Fig2VerticalCardDark,
  Fig2VerticalCardLight,
  Fig3VerticalCardDark,
  Fig3VerticalCardLight,
  Fig4VerticalCardDark,
  Fig4VerticalCardLight,
  Fig5VerticalCardDark,
  Fig5VerticalCardLight,
  Fig6VerticalCardDark,
  Fig6VerticalCardLight,
  Fig7VerticalCardDark,
  Fig7VerticalCardLight,
} from "./images";
...
<DoDontCaution
  imageSrc={[Fig1VerticalCardLight, Fig1VerticalCardDark]}
...
<DoDontCaution
  imageSrc={[Fig2VerticalCardLight, Fig2VerticalCardDark]}
...
- B: Heading
- C: Subtitle
- D: Adornment, for example [status tags](/components/feedback-progress/status-tag)
...
<DoubleDoDontCaution>
  <DoDontCaution
    imageSrc={[Fig3VerticalCardLight, Fig3VerticalCardDark]}
  ...
  />
  <DoDontCaution
    imageSrc={[Fig4VerticalCardLight, Fig4VerticalCardDark]}
...
<DoDontCaution
  imageSrc={[Fig5VerticalCardLight, Fig5VerticalCardDark]}
...
Include an expand button (E) if you include content in the [expandable area](/components/layout/card-vertical#5-expandable-area-interactive-cards-only).
...
<DoDontCaution
  imageSrc={[Fig6VerticalCardLight, Fig6VerticalCardDark]}
...
<DoDontCaution
  imageSrc={[Fig7VerticalCardLight, Fig7VerticalCardDark]}
...
<DoubleDoDontCaution>
  <DoDontCaution
    imageSrc={[Fig10VerticalCardLight, Fig10VerticalCardDark]}
  ...
  />
  <DoDontCaution
    imageSrc={[Fig11VerticalCardLight, Fig11VerticalCardDark]}
