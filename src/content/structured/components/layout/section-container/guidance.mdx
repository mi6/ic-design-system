---
path: "/components/layout/section-container"
...
- [Top navigation](/components/navigation/top-navigation): Full-width section container.
- [Footer](/components/layout/footer): Full-width section container.
- [Hero](/components/navigation/hero): Centred section container.
- [Page header](/components/navigation/page-header): Centred section container.
...
<DoDontCaution
  imageSrc={[Fig1SectionLight, Fig1SectionDark]}
...
<DoDontCaution
  imageSrc={[Fig2SectionLight, Fig2SectionDark]}
...
<DoDontCaution
  imageSrc={[Fig3SectionLight, Fig3SectionDark]}
...
<DoDontCaution
  imageSrc={[Fig4SectionLight, Fig4SectionDark]}
...
<DoDontCaution
  imageSrc={[Fig5SectionLight, Fig5SectionDark]}
