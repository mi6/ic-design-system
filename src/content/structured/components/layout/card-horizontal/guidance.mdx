---
path: "/components/layout/card-horizontal"
...
Don’t use a horizontal card to display large amounts of content about an item, consider using a [Data Table](/components/data-display/data-table) instead.
...
Horizontal card content is similar to the static and clickable variants of [Vertical card](/components/layout/card-vertical); however, it does not include an interaction area.
...
- [Vertical card](/Components/layout/card-vertical)
