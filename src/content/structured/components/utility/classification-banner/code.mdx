---
path: "/components/utility/classification-banner/code"
...
contribute: "https://github.com/mi6/ic-design-system/tree/main/src/content/structured/components/utility/classification-banner"

tabs:
  [
    { title: "Guidance", path: "/components/utility/classification-banner" },
    { title: "Code", path: "/components/utility/classification-banner/code" },
    {
      title: "Accessibility",
      path: "/components/utility/classification-banner/accessibility",
    },
  ]
---
