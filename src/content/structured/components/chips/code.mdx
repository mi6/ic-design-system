...
export const snippetsOutline = [
  {
    language: "Web component",
    snippet: `<ic-chip label="Small" size="small" variant="outlined">
    <svg
      slot="icon"
      width="20"
      height="20"
  ...
  {
    language: "React",
    snippet: `<IcChip label="Small" size="small" variant="outlined">
    <SlottedSVG
      slot="icon"
      width="20"
      height="20"
...
<ic-chip label="Default" variant="outlined" dismissible="true" disabled="true">
  <svg
    slot="icon"
    width="20"
    height="20"
