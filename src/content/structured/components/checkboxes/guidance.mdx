...
<DoDontCaution
  ...
  imageAlt="Two forms containing a checklist and a text input. One uses default sizing resulting in larger spacing between components. The other uses dense sizing that reduces space between components and results in a shorter vertical height for the same form."
  state="good"
