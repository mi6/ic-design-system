...
contribute: "https://github.com/mi6/ic-design-system/tree/main/src/content/structured/components/navigation/tabs"

tabs:
  [
    { title: "Guidance", path: "/components/navigation/tabs" },
    { title: "Code", path: "/components/navigation/tabs/code" },
    {
      title: "Accessibility",
      path: "/components/navigation/tabs/accessibility",
    },
  ]
---
...
Don’t use tabs if the order of the content is important, such as in a checkout process. Instead use a [stepper](/components/feedback-progress/stepper) to order the sections into a linear process.
