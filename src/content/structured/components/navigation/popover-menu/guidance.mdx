---
path: "/components/navigation/popover-menu"
...
contribute: "https://github.com/mi6/ic-design-system/tree/main/src/content/structured/components/navigation/popover-menu"

tabs:
  [
    { title: "Guidance", path: "/components/navigation/popover-menu" },
    { title: "Code", path: "/components/navigation/popover-menu/code" },
    {
      title: "Accessibility",
      path: "/components/navigation/popover-menu/accessibility",
    },
  ]
---
...
Don’t include any other content within a popover menu other than the elements described in this page. If additional information is required about an action, consider using a [dialog](/components/feedback-progress/dialog) instead.
