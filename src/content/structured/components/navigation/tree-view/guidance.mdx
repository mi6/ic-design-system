---
path: "/components/navigation/tree-view"
...
<DoubleDoDontCaution>
  <DoDontCaution
    imageSrc={[Fig1TreeViewLight, Fig1TreeViewDark]}
...
<DoubleDoDontCaution>
  <DoDontCaution
    imageSrc={[Fig2TreeViewLight, Fig2TreeViewDark]}
...
Avoid using tree view for dense or complicated data display. Consider if this could be displayed better with a [data table](/components/data-display/data-table) or a grid.

<DoubleDoDontCaution>
  <DoDontCaution
    imageSrc={[Fig3TreeViewLight, Fig3TreeViewDark]}
...
<DoDontCaution
  imageSrc={[Fig4TreeViewLight, Fig4TreeViewDark]}
