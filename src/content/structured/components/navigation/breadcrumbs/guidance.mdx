...
contribute: "https://github.com/mi6/ic-design-system/tree/main/src/content/structured/components/navigation/breadcrumb"

tabs:
  [
    { title: "Guidance", path: "/components/navigation/breadcrumb" },
    { title: "Code", path: "/components/navigation/breadcrumb/code" },
    {
      title: "Accessibility",
      path: "/components/navigation/breadcrumb/accessibility",
    },
  ]
...
Always position breadcrumbs at the top of page content but below main navigation components such as the [top navigation](/components/navigation/top-navigation).
