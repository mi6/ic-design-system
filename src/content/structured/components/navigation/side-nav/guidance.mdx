---
path: "/components/navigation/side-navigation"
...
contribute: "https://github.com/mi6/ic-design-system/tree/main/src/content/structured/components/navigation/side-navigation"

tabs:
  [
    { title: "Guidance", path: "/components/navigation/side-navigation" },
    { title: "Code", path: "/components/navigation/side-navigation/code" },
    {
      title: "Accessibility",
      path: "/components/navigation/side-navigation/accessibility",
    },
  ]
...
Use side navigation alongside additional components like [page headers](/components/navigation/page-header) to create a variety of different [layouts](/styles/layout-spacing) and navigation styles.

## When not to use

For intranet-style and content-heavy apps, use [top navigation](/components/navigation/top-navigation) as it's better suited for providing links to a large number of pages.

Use either side navigation or top navigation. Don't use both at the same time.

<DoDontCaution
  imageSrc={[Fig1SideNavLight, Fig1SideNavDark]}
...
Avoid using side navigation if the app has many destinations grouped into a multi-level hierarchy. Instead use a [top navigation](/components/navigation/top-navigation) with grouped links.

<DoDontCaution
  imageSrc={[Fig2SideNavLight, Fig2SideNavDark]}
...
<DoDontCaution
  imageSrc={[Fig3SideNavLight, Fig3SideNavDark]}
...
<DoDontCaution
  imageSrc={[Fig4SideNavLight, Fig4SideNavDark]}
...
<DoDontCaution
  imageSrc={[Fig5SideNavLight, Fig5SideNavDark]}
...
<DoDontCaution
  imageSrc={[Fig6SideNavLight, Fig6SideNavDark]}
...
<DoDontCaution
  imageSrc={[Fig7SideNavLight, Fig7SideNavDark]}
...
<DoDontCaution
  imageSrc={[Fig8SideNavLight, Fig8SideNavDark]}
...
<DoDontCaution
  imageSrc={[Fig9SideNavLight, Fig9SideNavDark]}
...
<DoDontCaution
  imageSrc={[Fig10SideNavLight, Fig10SideNavDark]}
...
<DoDontCaution
  imageSrc={[Fig11SideNavLight, Fig11SideNavDark]}
