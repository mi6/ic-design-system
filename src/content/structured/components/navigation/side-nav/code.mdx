---
path: "/components/navigation/side-navigation/code"
...
<ic-link target="_blank" href="https://pictogrammers.com/library/mdi/" rel="noreferrer noopener nofollow">MDI</ic-link> can be imported from the `@mdi/js` package and used in `<SlottedSVG>`.
To scale the icons, use the <ic-link target="_blank" href="https://css-tricks.com/scale-svg/#aa-the-viewbox-attribute" rel="noreferrer noopener nofollow">'viewBox' attribute</ic-link>.
