...
export const snippetsSmall = [
  {
    language: "Web component",
    snippet: `<ic-switch label="Unlimited coffee" show-state="true" size="small"></ic-switch>`,
  },
  {
    language: "React",
    snippet: `<IcSwitch label="Unlimited coffee" showState size="small"/>`,
  },
];

<ComponentPreview snippets={snippetsSmall}>
  <IcSwitch label="Unlimited coffee" showState size="small" />
</ComponentPreview>
