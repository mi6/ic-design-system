...
import fig3 from "./images/fig-3-labels-helper-text-placeholder-text.png";
import fig4 from "./images/fig-4-with-helper-text.png";
import fig5 from "./images/fig-5-with-no-helper-text.png";
import fig6 from "./images/fig-6-adjust-input-size-to-match-other-form-components.png";
import fig7 from "./images/fig-7-dont-use-mixed-size-components.png";
import fig8 from "./images/fig-8-short-date-input-width.png";
import fig9 from "./images/fig-9-matched-date-input-width.png";
import fig10 from "./images/fig-10-excessive-matched-date-input-width.png";
import fig11 from "./images/fig-11-success-validation.png";
import fig12 from "./images/fig-12-error-validation-correct.png";
import fig13 from "./images/fig-13-error-validation-incorrect.png";
