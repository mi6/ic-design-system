...
A [date input](/components/canary/date-input) is contained within the date picker.
...
Use the clear icon in a [date input](/components/canary/date-input) or clear button in a date picker to clear an input.
