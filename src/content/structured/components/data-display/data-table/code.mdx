---
path: "/components/data-display/data-table/code"
...
tabs:
  [
    { title: "Guidance", path: "/components/data-display/data-table" },
    { title: "Code", path: "/components/data-display/data-table/code" },
    {
      title: "Accessibility",
      path: "/components/data-display/data-table/accessibility",
    },
  ]
---
...
You can customise your own [ic-empty-state](/components/feedback-progress/empty-state) component and slot it into the data table using the `empty-state` slot, to reflect different scenarios.
...
When a user wants to fetch their data asynchronously, a `loading` prop can be set to `true`, which then renders a circular variant of the [ic-loading-indicator](/components/feedback-progress/loading-indicator).
...
By setting `rowSelection` to `true`, [ic-checkbox](/components/inputs/checkbox) elements will appear in the leftmost column, with one in the header.
