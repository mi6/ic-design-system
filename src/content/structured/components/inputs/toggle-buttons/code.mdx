---
path: "/components/inputs/toggle-button/code"
...
contribute: "https://github.com/mi6/ic-design-system/tree/main/src/content/structured/components/inputs/toggle-button"
...
<ic-toggle-button label="Switch to oat milk" theme="dark" loading="true" checked="true"></ic-toggle-button>`,
    ...
    display: flex;
    flex-wrap: wrap;
    background-color: var(--ic-color-page-background-dark);
    padding: var(--ic-space-md);
    gap: var(--ic-space-xs);
  }
</style>
