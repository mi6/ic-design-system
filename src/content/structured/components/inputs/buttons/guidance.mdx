...
contribute: "https://github.com/mi6/ic-design-system/tree/main/src/content/structured/components/inputs/button"

tabs:
  [
    { title: "Guidance", path: "/components/inputs/button" },
    { title: "Code", path: "/components/inputs/button/code" },
    { title: "Accessibility", path: "/components/inputs/button/accessibility" },
  ]
---
...
Add labels to all icon buttons using a [tooltip](/components/feedback-progress/tooltip), which is useful to sighted users too.
...
- [Tooltips](/components/feedback-progress/tooltip)
