...
A [date input](/components/inputs/date-input) is contained within the date picker.
...
Use the clear icon in a [date input](/components/inputs/date-input) or clear button in a date picker to clear an input.
