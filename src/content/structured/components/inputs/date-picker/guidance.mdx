...
tabs:
  [
    { title: "Guidance", path: "/components/inputs/date-picker" },
    { title: "Code", path: "/components/inputs/date-picker/code" },
    {
      title: "Accessibility",
      path: "/components/inputs/date-picker/accessibility",
    },
  ]
...
Avoid using a date picker for well-known dates, such as dates of birth, because it is often easier to type this into a field. For example, if selecting 30/07/1966, consider using [date input](/components/inputs/date-input) as a date picker would require many clicks to arrive at the same date.
...
Use the [date input](/components/inputs/date-input) resizing options to change size of the input and calendar between minimum and maximum widths. For example, to create a larger date picker, resize width of [date input](/components/inputs/date-input).
...
The [date input](/components/inputs/date-input) and the date picker update according to any input made. For example, if 10/10/2100 is entered in the [date input](/components/inputs/date-input), the date picker will open to display the selection.
...
See [date input](/components/inputs/date-input#validation) for detailed guidance on how to display errors within the date picker.
