...
| Google Doubleclick| sis.gov.uk        | These cookies are used to help us to monitor which digital advertising channels are most effective. By recording which job adverts are generating the most interest, we are able to make better choices about where to advertise.                           | APISID, SSID, NID, PREF, drt, SID, SAPISID, id, HSID |
