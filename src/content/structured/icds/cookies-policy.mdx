...
<CookiesData headers={cookiesHeaders} data={essentialCookies} caption='Essential Cookies Table' />
...
<CookiesData headers={cookiesHeaders} data={optionalCookies} caption='Optional Cookies Table' />
