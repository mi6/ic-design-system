...
Our essential cookies are: `ICDSPREF` and `_ga_L8G7D6EHQ` in the table above. The `_ga_539HLQQT3Y` and the Google Doubleclick cookies are auto-generated from our parent domain, `sis.gov.uk`. They always need to be on.
