...
| Google Analytics   | These cookies are used to collect essential performance data so that we can review performance of the website, including aspects such as number of visitors and which pages are most popular.                                     | \_ga, \_gat, gatsby_ga-gdpr, \_ga_539HLQQT3Y, \_ga_L8G7D6EHQB      |
...
Our essential cookies are: `ICDSPREF`, `_Host-gh_pages_session`, `_Host-gh_pages_id`, `_Host-gh_pages_token` and `_ga_L8G7D6EHQ` in the table above. The `_ga_539HLQQT3Y` and the Google Doubleclick cookies are auto-generated from our parent domain, `sis.gov.uk`. They always need to be on.
