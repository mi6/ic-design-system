...
Autism, also called Autism Spectrum Disorder (ASD), is a condition that affects the way someone sees the world, processes information and interacts with others.
...
<p>
  ...
  <ic-link
    target="_blank"
    href="https://www.mencap.org.uk/learning-disability-explained/learning-disability-and-conditions/autism-asd"
    rel="noreferrer noopener nofollow"
  >
    Autism (ASD) at Mencap
  </ic-link>{" "}
  or{" "}
  <ic-link
    target="_blank"
