...
<IcAlert
  ...
  Please ensure that any text in the diagram is accessible with a screen reader."
  variant="warning"
/>
...
Where possible, use [simple words](/styles/content-style/voice-and-tone) no harder than a reading age of 9.
