...
<p>
  ...
  has designed effective accessibility posters from which the accessibility
  needs section has taken inspiration.
</p>
...
Allowing people to tab between each element on a page instead of using the mouse.
