...
Have a look at the [General accessibility](/accessibility/needs/general) and explore how each accessibility need will require different accessible features.
