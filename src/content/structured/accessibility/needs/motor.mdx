...
<DoubleDoDontCaution>
  <DoDontCaution
    ...
    state="good"
    caption="The cursors show the clickable areas include the text for the buttons."
  />
  <DoDontCaution
    ...
    state="bad"
    caption="The cursors show the smaller clickable areas for the buttons, which make it harder for people with motor needs."
  />
</DoubleDoDontCaution>
