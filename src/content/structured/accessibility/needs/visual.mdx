...
<DoubleDoDontCaution>
  ...
  <DoDontCaution
    ...
    state="bad"
    caption="A graphic of text field validation showing an error, a warning and a success using only colour. The text boxes are red, amber and green, which could mean anything out of context."
  />
</DoubleDoDontCaution>
