...
This page tells you how to fill in an [Accessibility Statement](/accessibility/documenting/accessibility-statements) if you work for MI6, MI5, GCHQ, HMGCC (our national security partner) or one of our additional partners. [Templates are available](/accessibility/documenting/accessibility-statements#the-template).
...
<p>
  ...
  <ic-link
    target=""
    href="/accessibility-statement-guidance.docx"
    rel="noreferrer noopener nofollow"
    download="true"
  >
    Accessibility Statement guidance (DOCX)
  </ic-link>
</p>
...
This section is used to highlight how accessible the app is. The sample bullet points aren't a checklist but will be true when the app is compliant to the Web Content Accessibility Guidelines (WCAG) Level A and AA criteria.
...
This section is used to explain how the app was tested against the WCAG standard.
