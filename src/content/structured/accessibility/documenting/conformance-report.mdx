...
- [Download the ICDS Components Accessibility Conformance Report](/ICDS_Components_accessibility-conformance-report-04-11-25.docx).
- [Download the ICDS Guidance Site Accessibility Conformance Report](/ICDS_Guidance_accessibility-conformance-report-04-11-25.docx).
...
- Use the [WCAG (VPAT®) template](/VPAT2.5Rev_WCAG_February2025.docx) for apps and services with only a user interface (browser-based or otherwise).

- Use the [EN 301 549 (VPAT®) template](/VPAT2.5Rev_EU_February2025.docx) for apps and services that include hardware. It includes all the WCAG criteria, so only one Report is needed.
