...
Use the full range of [accessibility testing](/accessbility/testing) methods to make sure your app or service is accessible to everyone. Just filling in a Report as a checklist won't give a full picture of how accessible (to WCAG or EN 301 549) your app or service is.
...
- Use the [EN 301 549 (VPAT®) template](/blank-accessibility-conformance-report-vpat-wcag-24rev.docx) for apps and services which includes hardware. It includes all the WCAG criteria, so only one Report is needed.
