...
Click here to [download the IC Design System's Accessibility Conformance Report](/icds-accessibility-conformance-report-17-01-24.docx).
...
- Use the [EN 301 549 (VPAT®) template](/VPAT2.5EU-November2023.doc) for apps and services which includes hardware. It includes all the WCAG criteria, so only one Report is needed.
