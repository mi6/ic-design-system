...
You can now use any of the components so long as your HTML page includes the output file defined in your `webpack.config.js`. For example, including an [ic-status-tag](/components/feedback-progress/status-tag) below:
