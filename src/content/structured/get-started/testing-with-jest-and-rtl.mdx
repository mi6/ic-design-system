---
path: "/get-started/test-components/testing-with-jest-and-rtl"

date: "2023-02-16"

title: "Testing with Jest and React Testing Library"

subTitle: "How to test our components with Jest and RTL"
...
Below are examples on testing `@ukic/react` components using RTL, Jest and Shadow DOM Testing Library with a test-app.

<ComponentTesting snippetArray={snippetArray} showStackblitzBtn />
