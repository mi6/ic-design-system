...
- Fix ic-divider causing accessibility errors when in an ic-side-navigation.
- Update components to have no transitions when reduced motion is preferred.
- Addition of label slot to ic-input-label and ic-checkbox-group.
- Move ic-card-horizontal to core web components.
- Remove ic-card-horizontal from canary components.
