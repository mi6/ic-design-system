...
- Add a mutation observer to check for dynamically render nav items in side nav.
- Add ability to set custom classification text in classification banner.
- Move ic-pagination-bar to core web components.
- Remove ic-pagination-bar from canary components.
