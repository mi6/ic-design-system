...
- [Toast](/components/toasts) component.
- Updates to the [card](/components/cards) component, with images and expandable area.
- [Compact stepper](/components/stepper) component.
- [Chips](/components/chips) component.
...
- Functionality improvements to [clickable chips](/components/chips).
