...
- Align the end component to match label for data list.
- Force loading indicator to be circular when size is 'icon'.
- Update checkbox group to correctly pass down size and disabled props.
- Update spacing between icon and text in select menu.
- Modify time-input and time-selector 'disableTimes' prop.
- Remove seconds from ic-time-selector.
