...
4. Refer to the technical instructions for [Design System](https://github.com/mi6/ic-design-system/tree/main/CONTRIBUTING.md) or the [UI Kit repository](https://github.com/mi6/ic-ui-kit/blob/main/CONTRIBUTING.md) coding standards and practices.
