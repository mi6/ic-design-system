...
4. Refer to the technical instructions for [Design System](https://github.com/mi6/ic-design-system/tree/main/CONTRIBUTING.md) or the [UI Kit repository](https://github.com/mi6/ic-ui-kit/blob/main/CONTRIBUTING.md) coding standards and practices. If you're contributing a feature, you might want to read through the [glossary of terms](/community/glossary-of-terms) to help with prop/slot naming.
